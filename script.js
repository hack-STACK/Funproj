...
"Kamu janji tidak akan membuat aku jadi bingung?",
  ...
  function showFinalMessage() {
      ...
      document.getElementById("messageText").innerText = "Thank you for answering all the questions!";
      submitAnswers(); // Send the answers to the server
      showConfetti();
  }
  
  function submitAnswers() {
      fetch('http://localhost:3000/submit', { // Replace with your actual server endpoint
          method: 'POST',
          headers: {
